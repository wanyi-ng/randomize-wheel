      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="relative mx-auto max-w-[37.5rem] pt-20 lg:pt-40 text-center pb-6 lg:pb-24">
          ...
          <p className="mt-4 text-base leading-7 text-slate-600">
            Learn more about the Randomizer Wheel licensing model. Have a
            question? Get in touch and we’ll help you out.
          </p>
        </div>
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-[40rem] prose-sm prose prose-slate prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600 space-y-12">
            <section id="overview">
              <h2>Overview</h2>
              <p>
                This website is operated by Randomizer Wheel. Throughout the
                site, the terms “we”, “us” and “our” refer to Randomizer Wheel.
                Randomizer Wheel offers this website, including all information,
            ...
            <section id="section-12">
              ...
              <ul>
                ...
                <li>
                  ...
                  spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for
                  any obscene or immoral purpose; or (k) to interfere with or
            ...
            <section id="section-13">
              ...
              <p>
                In no case shall Randomizer Wheel, our directors, officers,
            ...
            <section id="section-14">
              ...
              <p>
                You agree to indemnify, defend and hold harmless Randomizer
                Wheel and our parent, subsidiaries, affiliates, partners,
            ...
            <section id="section-20">
              ...
              <p>
                ...
                [INSERT EMAIL ADDRESS] [INSERT BUSINESS ADDRESS] [INSERT
                BUSINESS PHONE NUMBER] [INSERT BUSINESS REGISTRATION NUMBER]
                [INSERT VAT NUMBER]
              </p>
            </section>
          </div>
